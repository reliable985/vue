  ...
  <div class="login_box">
    ...
    <div class="phone_login_box">
      ...
      <label class="input_phone">
        ...
        <input  v-model="email" name="email" v-validate="{required: true,regex: /^[A-Za-zd]+([-_.][A-Za-zd]+)*@([A-Za-zd]+[-.])+[A-Za-zd]{2,5}$/}" type="text" placeholder="请输入邮箱号" />
      ...
      <label class="input_code">
        ...
        <button :disabled="!show || timer >0"   class="get_phone_code"  @click="getCode" >
